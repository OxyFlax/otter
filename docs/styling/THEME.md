    ...
    primary: (
      color: (
        ...
        details: ( // Optional property
          descriptions: 'My primary color used as website main color', // Optional property
...
In certain cases we want to define variable, make it part of the extracted metadata but without defining a full Otter Theme.
...
:root {
  @include o3r.var('o3r-primary-color', #000, (descriptions: 'My primary color used as website main color', label: 'My primary color', type: 'color', category: 'main color', tags: ('main', 'color', 'primary')));
...
The both function and mixins `o3r.var` can be used to override variable details.
...
:root { @include o3r.var('my-variable', #000, (descriptions: 'new description')); }

// override only the details of the variable "my-variable" from the theme:
$res: o3r.var('my-variable', null, (descriptions: 'new description'));
