import { computeComponentIdentifier, deepFill } from '@o3r/core';
 ...
 * @deprecated use {@link computeComponentIdentifier} from @o3r/core. Will be removed in v12
...
export function computeConfigurationName(componentName: string, libraryName?: string) {
  return computeComponentIdentifier(componentName, libraryName);
}
