...
import { AssetPathOverrideStore, setAssetPathOverride } from '../stores';
import { ActionUpdateAssetBlock, RULES_ENGINE_ASSET_UPDATE_ACTION_TYPE } from './asset.interfaces';
...
export class AssetRulesEngineActionHandler implements RulesEngineActionHandler<ActionUpdateAssetBlock> {
  ...
  constructor(private store: Store<AssetPathOverrideStore>) {
  }
